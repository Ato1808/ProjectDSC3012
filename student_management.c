...
void infor_default ( stu *infor )
{
    ...
    strcpy ((*infor).gender[2], "Nu");
                    /*Score*/
    (*infor).score_math[0] = 7.8; (*infor).score_physics[0] = 7.5; (*infor).score_chemistry[0] = 8;
...
void input_recycle ( stu *infor, stu_r *infor_r, int *pos_del, int *num_recycle_student, int *recycle_student )
{
    (*num_recycle_student) += 1;
    (*recycle_student) += 1;
    for (int j = *recycle_student; j < *num_recycle_student; j++)
    {
...
void output_recycle ( stu_r infor_r, int num_recycle_student)
{     
    ...
    printf ("%19s", "[Physics score]"); 
    printf ("%21s", "[Chemistry score]");
    for (int j = 0; j < num_recycle_student; j++)
    {   
        printf ("\n   %-13d", j);
...
void add_input_student_r (stu *infor, stu_r *infor_r, int *num_new_student, int *pos_add, int *pos_add_r, int *num_recycle_student)
{
    for (int i = ((*num_new_student) + 3) + 1; i > *pos_add; i--)
    {
        strcpy ((*infor).student_id[i], (*infor).student_id[i - 1]);
    ...
    for (int i = *pos_add_r; i < (*num_recycle_student) - 1; i++)
    {
...
int main ()
{
   ...
   /* Variables for modifying */
    ...
    stu_r infor_r;
    int num_recycle_student = 0; 
    int recycle_student = -1; 
    ...
    {   
        ...
        switch (select_menu)
        {
            ...
            case 4:
            {
                ...
                scanf ("%d", &pos_del);   
                input_recycle (&infor, &infor_r, &pos_del, &num_recycle_student, &recycle_student );
            ...
            case 5:
            {
                for (int j = 0; j < num_recycle_student; j++)
                {
                    ...
                    else 
                    {
                        ...
                        scanf ("%d", &pos_add_r);
                        if (pos_add_r > num_recycle_student - 1)
                        {
                        ...
                        {
                            add_input_student_r (&infor, &infor_r, &num_new_student, &pos_add, &pos_add_r, &num_recycle_student);
                            break;
                        }
                    }
                }
            ...
            case 6:
            {
                output_recycle (infor_r, num_recycle_student);
            }break;                  
            case 7:
            {
